...
const prompt = ai.definePrompt({
  ...
  **CRITICAL RULE**: Prioritize the user's chosen language.
  ...
  {{else}}
  You MUST respond in the exact same language and script the user uses. If the user writes in Hinglish (Hindi words with English letters), you MUST reply in Hinglish. Do not switch to the Devanagari script. For example, if the user says, "Main theek nahi hu," your reply should be something like, "Main samajh sakta hu," NOT "मैं समझ सकता हूँ."
  {{/if}}
