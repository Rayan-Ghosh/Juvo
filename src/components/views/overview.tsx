...
import { updateUserLastSeen } from '@/services/profile';
...
const Overview = () => {
    ...
    const handleMoodSelect = async (moodName: string, moodValue: number) => {
        ...
        try {
            ...
            fetchMoodData(); // Refetch data to update the UI
        } catch (error) {
            toast({
                variant: 'destructive',
                title: 'Error',
    ...
    return (
        <div className="p-4 sm:p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <AnimatedDiv className="lg:col-span-2" style={{ animationDelay: '300ms' }}>
                    <Card>
                        <CardHeader>
                ...
                <AnimatedDiv className="lg:col-span-1" style={{ animationDelay: '400ms' }}>
                    <ResourcesView />
                </AnimatedDiv>
            </div>
        </div>
